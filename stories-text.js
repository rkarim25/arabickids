...
const TEXT_STORIES = [
  ...
  },
  {
    id: 'ts-samak',
    level: 1,
    art: { dir: 'art', file: 'samak.jpg' },
    title: 'لُولُو وَسَمَك',
    titleEn: 'Lulu and a fish',
    blurb: 'A small cat, a big fish, and a very happy ending.',
    lines: [
      { ar: 'هَـٰذِهِ لُولُو.', en: 'This is Lulu.' },
      { ar: 'لُولُو جَائِعَة.', en: 'Lulu is hungry.' },
      { ar: 'هُنَا سَمَك كَبِير.', en: 'Here is big fish.' },
      { ar: 'سَمَك كَبِير!', en: 'A big fish!' },
      { ar: 'لُولُو تُرِيدُ سَمَك.', en: 'Lulu wants fish.' },
      { ar: 'جَاءَ بَابَا هُنَا.', en: 'Baba came here.' },
      { ar: 'هَـٰذَا سَمَك لَكِ.', en: 'Here is fish for you.' },
      { ar: 'لُولُو سَعِيدَة كَثِيرًا.', en: 'Lulu is very happy.' },
    ],
  },
  {
    id: 'ts-haqiba',
    level: 2,
    art: { dir: 'art', file: 'haqiba.jpg' },
    title: 'أَيْنَ حَقِيبَتِي؟',
    titleEn: 'Where is my bag?',
    blurb: 'Adam searches every corner. Lulu is sitting on the answer.',
    lines: [
      { ar: 'أَيْنَ حَقِيبَتِي يَا مَامَا؟', en: 'Where is my bag, Mama?' },
      { ar: 'الْحَقِيبَةُ لَيْسَتْ فِي الْغُرْفَةِ.', en: 'The bag is not in the room.' },
      { ar: 'هَلْ هِيَ تَحْتَ الْمَائِدَةِ؟', en: 'Is it under the table?' },
      { ar: 'نَظَرَ أَدَم فِي الْمَطْبَخِ.', en: 'Adam looked in the kitchen.' },
      { ar: 'لُولُو فَوْقَ الْحَقِيبَةِ!', en: 'Lulu is on top of the bag!' },
      { ar: 'قَالَ بَابَا: وَجَدْنَا الْحَقِيبَةَ!', en: 'Baba said: we found the bag!' },
      { ar: 'ضَحِكَ أَدَم وَأَخَذَ الْحَقِيبَةَ.', en: 'Adam laughed and took the bag.' },
    ],
  },
  {
    id: 'ts-jubn',
    level: 3,
    art: { dir: 'art', file: 'lulu-ghurab.jpg' },
    title: 'الْغُرَابُ وَالْجُبْن',
    titleEn: 'The crow and the cheese',
    blurb: 'He wanted to show off his singing. He lost his lunch.',
    lines: [
      { ar: 'وَجَدَ الْغُرَابُ جُبْنًا فَوْقَ الْحَائِطِ.', en: 'The crow found cheese on the wall.' },
      { ar: 'طَارَ الْغُرَابُ إِلَى الْغُصْنِ الْعَالِي.', en: 'The crow flew to the high branch.' },
      { ar: 'رَأَتْهُ قِطَّةٌ ذَكِيَّةٌ مِنَ الْأَرْضِ.', en: 'A clever cat saw it from the ground.' },
      { ar: 'قَالَتِ الْقِطَّةُ: صَوْتُكَ جَمِيلٌ جِدًّا!', en: 'The cat said: your voice is very beautiful!' },
      { ar: 'هَلْ تُغَنِّي لِي يَا صَدِيقِي؟', en: 'Will you sing for me, my friend?' },
      { ar: 'فَتَحَ الْغُرَابُ فَمَهُ فَسَقَطَ الْجُبْنُ!', en: 'The crow opened his mouth and the cheese fell!' },
      { ar: 'أَخَذَتِ الْقِطَّةُ الْجُبْنَ وَضَحِكَتْ كَثِيرًا.', en: 'The cat took the cheese and laughed a lot.' },
    ],
  },
  {
    id: 'ts-sibaq',
    level: 4,
    art: { dir: 'art', file: 'kalila.jpg' },
    title: 'السِّبَاقُ فِي الْغَابَةِ',
    titleEn: 'The race in the forest',
    blurb: 'The fastest animal took a nap. The slow one kept walking.',
    lines: [
      { ar: 'قَالَ الْأَرْنَبُ لِلسُّلَحْفَاةِ: أَنَا أَسْرَعُ حَيَوَانٍ فِي الْغَابَةِ!', en: 'The hare said to the tortoise: I am the fastest animal in the forest!' },
      { ar: 'قَالَتِ السُّلَحْفَاةُ: هَيَّا نَتَسَابَقُ إِلَى الشَّجَرَةِ الْكَبِيرَةِ.', en: 'The tortoise said: let us race to the big tree.' },
      { ar: 'جَرَى الْأَرْنَبُ بِسُرْعَةٍ شَدِيدَةٍ وَتَرَكَ السُّلَحْفَاةَ بَعِيدًا خَلْفَهُ.', en: 'The hare ran with great speed and left the tortoise far behind him.' },
      { ar: 'قَالَ الْأَرْنَبُ: السُّلَحْفَاةُ بَطِيئَةٌ جِدًّا، سَأَنَامُ قَلِيلًا تَحْتَ الشَّمْسِ.', en: 'The hare said: the tortoise is very slow, I will sleep a little under the sun.' },
      { ar: 'نَامَ الْأَرْنَبُ نَوْمًا عَمِيقًا، أَمَّا السُّلَحْفَاةُ فَمَشَتْ وَلَمْ تَتَوَقَّفْ.', en: 'The hare slept deeply, while the tortoise walked and did not stop.' },
      { ar: 'اِسْتَيْقَظَ الْأَرْنَبُ وَرَأَى السُّلَحْفَاةَ تَصِلُ إِلَى الشَّجَرَةِ أَوَّلًا!', en: 'The hare woke up and saw the tortoise reaching the tree first!' },
      { ar: 'فَرِحَتِ الْحَيَوَانَاتُ كُلُّهَا، وَتَعَلَّمَ الْأَرْنَبُ أَنَّ الصَّبْرَ يَغْلِبُ الْغُرُورَ.', en: 'All the animals rejoiced, and the hare learned that patience overcomes arrogance.' },
    ],
  },
];
